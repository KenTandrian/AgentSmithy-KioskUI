...
export class ConfigureBotComponent implements OnInit, AfterViewInit {
  ...
  handleStepFour() {
    ...
    this.howItWorksDescription = $localize`AI agents leverage foundation models, to process information, reason, and interact with their environment, enabling them to perform tasks autonomously. How they work:\n\n • Reasoning and Planning: Foundation models can help AI agents reason about complex situations, plan actions, and make decisions based on their understanding of the environment. \n • Action Execution: AI agents can use foundation models to generate instructions or commands that control their actions. \n • Tool Calling: AI agents can leverage tool calling capabilities to access external tools and APIs to perform tasks that the foundation model alone cannot handle, such as accessing databases, performing calculations, or making web requests.`;
    this.step = "model"
  }

  stepperConfig = [
    {
      heading: $localize`Industry`,
      stepHeading: $localize`Industry`,
      contentType: 'industry',
      subheading: $localize`AI tools are software applications or platforms that leverage artificial intelligence to automate tasks, analyze data, or generate outputs.`,
      options: [
        { 
          label: $localize`Finance`, 
          isSelected: false, 
          isDisabled: false,
          onClick: () => this.selectIndustry('finance'), 
          subtitle: $localize`Your finance agent has been configured with the following use case and tools:`,
          metadata: {
            prosHeading: '',
          prosSubheading: '',
          consHeading: '',
          consSubheading: '',
            usecase: $localize`Use case`,
            usecaseHeading: $localize`AI-Powered Investment Research Analyst for Alphabet`,
            usecaseSubheading: $localize`Provides financial insights on Alphabet by analyzing its financial reports, strategic initiatives, and management perspectives from its historical investor documents. (Disclaimer: This Agent is for demonstration purposes only)`,
            tool: $localize`Tool`,
            toolHeading: $localize`retrieve_info`,
            toolSubheading: $localize`This tool uses Vertex AI Search to perform Retrieval Augmented Generation (RAG) on a given dataset. This agent has access to the following dataset:\n\n\`Alphabet Investor PDFs\`: This dataset contains PDFs of quarterly earnings releases and annual reports for Alphabet for every quarter since 2004. The Annual reports include  financial statements (balance sheet, income statement, cash flow statement), a letter to shareholders, management discussion and analysis (MD&A), and information on corporate governance. The quarterly earnings releases also contain key financial statements like the income statement, balance sheet, and cash flow statement, along with management commentary and analysis of quarterly performance.`,
          },
          caption: '```python\nfrom langchain.agents import Tool \n\n# Define the tool (assuming \'get_weather\' function is already defined) \nweather_tool = Tool( \n\tname="Get Weather", \n\tfunc=get_weather, \n\tdescription="Get current weather for a location." \n)\n```'
        },
        { 
          label: $localize`Healthcare`, 
          isSelected: false, 
          isDisabled: false,
          onClick: () => this.selectIndustry('healthcare'),
          subtitle: $localize`Your healthcare agent has been configured with the following use case and tools:`,
          metadata: {
            prosHeading: '',
          prosSubheading: '',
          consHeading: '',
          consSubheading: '',
            usecase: $localize`Use case`,
            usecaseHeading: $localize`Symptom Checker and Triage Assistant`,
            usecaseSubheading: $localize`Analyzes general medical symptoms and acts as a virtual assistant to help triage patients to the appropriate level of care during consultations. (Disclaimer: This Agent is for demonstration purposes only and is NOT a substitute for professional medical advice)`,
            tool: $localize`Tool`,
            toolHeading: $localize`medical_publications_tool`,
            toolSubheading: $localize`Utilizes the PubMed API to pull data from the PubMed database, which is a free, searchable database developed and maintained by the National Center for Biotechnology Information (NCBI) and provides access to citations and abstracts of biomedical literature.\n\nretrieve_info: This tool uses Vertex AI Search to perform Retrieval Augmented Generation (RAG) on a given dataset. This agent has access to the following dataset:\n\n\`PriMock57 Healthcare consultations\`: This dataset consists of 57 mock medical primary care consultations held over 5 days by 7 clinicians and 57 fake patients, using case cards that present complaints, symptoms, medical & general history etc.`,
          },
        ...
        { 
          label: $localize`Retail`, 
          isSelected: false, 
          isDisabled: false,
          onClick: () => this.selectIndustry('retail'),
          subtitle: $localize`Your retail agent has been configured with the following use case and tools:`,
          metadata: {
            prosHeading: '',
          prosSubheading: '',
          consHeading: '',
          consSubheading: '',
            usecase: $localize`Use case`,
            usecaseHeading: $localize`Google Product Discovery Assistant`,
            usecaseSubheading: $localize`Answers product-specific questions on Google Products available on the Google Store (Disclaimer: This Agent is for demonstration purposes only)`,
            tool: $localize`Tool`,
            toolHeading: $localize`retrieve_info`,
        ...
        {
          label: $localize`Generic (Marketing)`,
          isSelected: false,
          isDisabled: false,
          onClick: () => this.selectIndustry('generic'),
          subtitle: $localize`This AI-powered assistant is engineered to enhance the capabilities of creative agencies when launching new websites or products.`,
          metadata: {
            prosHeading: '',
            prosSubheading: '',
            consHeading: '',
    ...
    {
      heading: $localize`Runtime`,
      stepHeading: $localize`Runtime`,
      contentType: 'runtime',
      subheading: $localize`An AI runtime provides the necessary environment to deploy and run machine learning models.`,
      options: [
        {
          label: $localize`Vertex AI Agent Engine`,
          isSelected: false,
          isDisabled: false,
          onClick: () => this.selectRunTime('AgentEngine'),
          subtitle: $localize`Quickly build, deploy, and run production-ready AI agents on Google Cloud with Vertex AI Agent Engine. This fully managed service handles infrastructure, scaling, and security so you can focus on your agent\'s logic.`,
          caption: './assets/images/vertex_agent.png',
          metadata: {
            prosHeading: $localize`Pros: `,
            prosSubheading: $localize`Enjoy simplified development, automatic scaling, built-in monitoring and evaluation, and reduced operational overhead.`,
            consHeading: $localize`Cons: `,
            consSubheading: $localize`Highly customized or very simple agents might find the platform\'s comprehensive features more than needed compared to basic self-hosting.`,
          },
        },
        {
          label: $localize`Cloud Run`,
          isSelected: false,
          isDisabled: false,
          onClick: () => this.selectRunTime('CloudRun/FastApi'),
          subtitle: $localize`Use Cloud Run to host your AI agents as scalable, cost-effective web services. It automatically adjusts resources to match demand and you only pay for what you use, making it efficient for fluctuating workloads.`,
          ...
          metadata: {
            prosHeading: $localize`Pros: `,
            prosSubheading: $localize`Highly scalable and cost-efficient (pay-per-use), seamless integration with other Google Cloud services (like Vertex AI), full flexibility to use any language or framework via containers, and simplified deployment.`,
            consHeading: $localize`Cons: `,
            consSubheading: $localize`Requires containerizing your agent, giving you more control but also more responsibility for the application packaging and environment compared to a fully managed platform.`,
          },
        }
      ],
      selectedOptionResponse: {
        ...
        metadata: {
          ...
          consHeading: '',
          consSubheading: '',
          vertexAiHeading: $localize`Vertex AI Agent Engine`,
          vertexAiSubheading: [
            $localize`Quick, easy solution for general reasoning tasks (QA, summarization).`,
            $localize`Managed scaling and infrastructure.`
          ],
          cloudRunHeading: $localize`Cloud Run`,
          cloudRunSubheading: [
            $localize`Fine-grained control and customization.`,
            $localize`Cost optimization and portability.`,
            $localize`Requires container expertise and infrastructure management.deployments, and the resources to develop and maintain the infrastructure.`
          ],
        },
      },
      hasNext: true,
    ...
    {
      heading: $localize`Orchestration Framework`,
      stepHeading: $localize`Framework`,
      contentType: 'framework',
      subheading: $localize`An AI orchestration framework manages workflows between AI models, tools, and data to build efficient AI systems.`,
      options: [
        // {
        //   label: 'LangChain',
        //   isSelected: false,
        ...
        // },
        {
          label: $localize`Agent Development Kit (ADK)`,
          isSelected: false,
          isDisabled: false,
          onClick: () => this.selectFramework('agent_development_kit'),
          subtitle: $localize`Agent Development Kit (ADK) is a flexible and modular framework for developing and deploying AI agents. While optimized for Gemini and the Google ecosystem, ADK is model-agnostic, deployment-agnostic, and is built for compatibility with other frameworks.`,
      ...
      selectedOptionResponse: {
        ...
        metadata: {
          ...
          consHeading: '',
          consSubheading: '',
          langchainHeading: $localize`LangChain: `,
          langchainSubheading: $localize`Versatile toolbox for building a wide range of LLM applications.`,
          langgraphHeading: $localize`LangGraph: `,
          langgraphSubheading: $localize`Build complex, stateful, multi-actor LLM workflows with a structured graph approach.`,
          llamaindexHeading: $localize`LlamaIndex: `,
          llamaindexSubheading: $localize`Connect LLMs to your private data for efficient indexing and retrieval.`,
          adkHeading: $localize`Agent Development Kit (ADK): `,
          adkSubheading: $localize`A flexible and modular framework for developing and deploying AI agents`,
          footer: $localize`Select the framework best suited to your project: LangChain for general use, LangGraph for complex workflows, and LlamaIndex for private data.`
        },
      },
      hasNext: true,
      hasPrevious: true,
      ...
      options: [
        {
          ...
          metadata: {
            prosHeading: $localize`Pros: `,
            prosSubheading: $localize`Exceptional long-context understanding, strong reasoning capabilities, multimodal input support, excellent for complex analysis and summarization.`,
            consHeading: $localize`Cons: `,
            consSubheading: $localize`Can be more resource-intensive and potentially slower for simpler tasks compared to \'Flash\' models.`,
          }
        },
        {
          label: $localize`Gemini 2.5 Flash`,
          isSelected: false,
          isDisabled: false,
          onClick: () => this.selectModel('gemini-2.5-flash'),
          subtitle: $localize`Gemini 2.5 Flash is a lightweight and highly efficient AI model designed for speed and cost-effectiveness. It\'s optimized for tasks requiring fast responses and high throughput, such as real-time chat, content summarization, and simple question answering. It still benefits from a large context window, making it a strong contender for many general-purpose applications.`,
        ...
        },
        {
          ...
          metadata: {
            prosHeading: $localize`Pros: `,
            prosSubheading: $localize`Extremely fast and low-cost, ideal for resource-constrained environments and high-frequency interactions, efficient for basic tasks.`,
            consHeading: $localize`Cons: `,
